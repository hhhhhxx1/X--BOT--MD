...
module.exports = {
	...
	STICKER_DATA: process.env.STICKER_DATA || `RIJU_EDITX;NVM_.RIJU`,
	SUDO: process.env.SUDO || "91919332446037",
	WORK_TYPE: process.env.WORK_TYPE || "private",
	SAVE_STATUS: toBool(process.env.SAVE_STATUS || "false"),
	STATUS_REPLY: toBool(process.env.STATUS_REPLY || "true"),
	STATUS_REPLY_MSG: process.env.STATUS_REPLY_MSG || "Nice Status #AUTO REPLY STATUS 🦫✨",
